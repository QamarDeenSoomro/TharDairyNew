...
export const translations: Record<Language, Translation> = {
  en: {
    ...
    smsHeaderMilkReceived: '🥛 Thar Dairy - Milk RECEIVED',
    smsHeaderMilkSent: '🥛 Thar Dairy - Milk SENT',
    smsHeaderPaymentReceived: '💰 Thar Dairy - Payment RECEIVED',
    smsHeaderPaymentPaid: '💰 Thar Dairy - Payment PAID',
    smsDear: 'Dear',
    smsMilkReceivedFrom: 'Milk received from you:',
    smsMilkDeliveredTo: 'Milk delivered to you:',
    smsPaymentReceivedFrom: 'Payment received from you:',
    smsPaymentPaidTo: 'Payment paid to you:',
    smsType: 'Type',
    smsQuantity: 'Quantity',
    smsRate: 'Rate',
    smsTotalAmount: 'Total Amount',
    smsTime: 'Time',
    smsDate: 'Date',
    smsAmount: 'Amount',
    smsMethod: 'Method',
    smsReference: 'Reference',
    smsThankYou: 'Thank you for your business!',
    smsFromTharDairy: '- Thar Dairy',
    smsLiters: 'liters',
    smsPerLiter: '/liter',
    smsMorning: 'Morning',
    smsCow: 'Cow',
  ...
  sd: {
    ...
    // SMS Template Messages
    smsHeaderMilkReceived: '🥛 تهر ڊيئري - کير وصول ڪيو',
    smsHeaderMilkSent: '🥛 تهر ڊيئري - کير موڪليو',
    smsHeaderPaymentReceived: '💰 تهر ڊيئري - ادائگي وصول',
    smsHeaderPaymentPaid: '💰 تهر ڊيئري - ادائگي ڪئي',
    smsDear: 'محترم',
    smsMilkReceivedFrom: 'توهان کان کير وصول ڪيو:',
    smsMilkDeliveredTo: 'توهان کي کير پهچايو:',
    smsPaymentReceivedFrom: 'توهان کان ادائگي وصول ڪئي:',
    smsPaymentPaidTo: 'توهان کي ادائگي ڪئي:',
    smsType: 'قسم',
    smsQuantity: 'مقدار',
    smsRate: 'ريٽ',
    smsTotalAmount: 'ڪل رقم',
    smsTime: 'وقت',
    smsDate: 'تاريخ',
    smsAmount: 'رقم',
    smsMethod: 'طريقو',
