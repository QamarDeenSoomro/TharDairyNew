...
export default function BankStatement() {
  ...
  const generateMessage = () => {
    ...
    return `*${currentParty.name} - Bank Statement*
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to send the bank statement to {currentParty?.name} via WhatsApp?
              <br />
      ...
      <AlertDialog open={showSMSConfirm} onOpenChange={setShowSMSConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to send the bank statement to {currentParty?.name} via SMS?
              <br />
              <span className="text-sm text-muted-foreground">Contact: {currentParty?.contact}</span>
            </AlertDialogDescription>
          </AlertDialogHeader>
