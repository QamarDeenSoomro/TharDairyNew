  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-6">
        ...
        <div className="space-y-4">
          <StatsCard
            ...
            details={{
              ...
              amount: `Rs. ${Math.round(filteredStats.receivedAmount)}`,
              averageRate: `Rs. ${filteredStats.receivedQuantity > 0 ? Math.round(filteredStats.receivedAmount / filteredStats.receivedQuantity) : 0}/L`
            }}
          />
          <StatsCard
            title="Milk Sent"
            ...
            details={{
              ...
              amount: `Rs. ${Math.round(filteredStats.sentAmount)}`,
              averageRate: `Rs. ${filteredStats.sentQuantity > 0 ? Math.round(filteredStats.sentAmount / filteredStats.sentQuantity) : 0}/L`
            }}
          />
        </div>
        ...
        <StatsCard
          title="Period Profit"
          value={`Rs. ${Math.round(filteredStats.profit)}`}
          color="success"
        />
        <StatsCard
          title="Pending Payments"
          value={`Rs. ${Math.round(filteredStats.pendingPayments)}`}
          color="warning"
        />
      </div>
